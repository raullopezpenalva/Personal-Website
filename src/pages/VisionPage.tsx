        ...
        <>
            ...
            >
                <Stack direction="column" gap="md" justifyContent="space-around" align="stretch" margin="sm">
                    <Text variant="body">Cuando me enfrento a un sistema complejo, lo primero que intento entender no es la herramienta ni la tecnología, sino la razón de existir. Todo sistema responde a una necesidad y transformación de energia (recursos, información o decisiones) hasta producir un resultado.</Text>
                    <Text variant="body">Intento observarlo desde una visión cenital: comprender cómo fluye esa transformación, cómo interactúan sus partes y en qué punto puede romporse el equilibrio. Sin esa perspectiva, calquier intervención es parcial</Text>
                    <BulletList>
                        ...
                        <Bullet>Puntos críticos y depedencias</Bullet>
            ...
            >
                <Stack className="stack-60-40" direction="row" gap="none" margin="lg">
                    <Stack className="stack-60-40-left" direction="column" gap="md" justifyContent="space-around" align="stretch" margin="sm">
                        <Text variant="body">No diseño sistemas solo para resolver el presente. Pienso en cómo podrían evoluciones: qué ocurrirá cuando crezcan, cuando cambien las condiciones o cuando aumente la complejidad</Text>
                        <Text variant="body">Siempre me ha resultado natural imagnar el estado final de un sistema antes de construirlo. Visualizar su arquitectura completa, sus compatibilidades, sus límites y su posible expansión</Text>
                        <BulletList>
                            <Bullet>Modularidad y separación de resposabilidades</Bullet>
            ...
            >
                <Stack direction="column" gap="md" justifyContent="space-around" align="stretch" margin="sm">
                    ...
                    <Text variant="body">No separo desarrollo, infraestructura y operación. Los veo como capas de una misma arquitectura que deber funcionar como un todo coherente.</Text>
                    <BulletList>
                        <Bullet>Arquitectura modular con responsabilidades claras</Bullet>
                        <Bullet>Infraestructura tratada como parte del diseño, como un añadido posterior</Bullet>
            ...
            >
                <Stack direction="column" gap="md" justifyContent="space-around" align="stretch" margin="sm">
                    ...
                    <Text variant="body">Soy consciente de que esa evolución requiere experiencia, profundidad técnica y exposición a sistemas reales. Por eso estoy construyendo esa base de forma intencional: entendiendo infraestructura, automatización y operación desde dentro.</Text>
